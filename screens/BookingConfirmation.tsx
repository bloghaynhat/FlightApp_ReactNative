                    ...
                    return (
                      <>
                        <View style={styles.detailRow}>
                          ...
                          <Text style={styles.detailValue}>{new Date(flight.departureTime).toLocaleString()}</Text>
                        </View>
                        <View style={styles.detailRow}>
                          <Text style={styles.detailLabel}>Đến nơi:</Text>
                          <Text style={styles.detailValue}>{new Date(flight.arrivalTime).toLocaleString()}</Text>
                        </View>
                        <View style={styles.detailRow}>
